 ...
 * @property {object} execOptions
 * @property {string} execOptions.exec
 * @property {string} [execOptions.script]
 * @property {number} [execOptions.scriptPosition]
 * @property {string[]} [execOptions.execArgs]
 */
