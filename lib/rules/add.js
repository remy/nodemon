...
// internal
const reEscComments = /\\#/g;
// note that '^^' is used in place of escaped comments
const reUnescapeComments = /\^\^/g;
const reComments = /#.*$/;
 ...
 */
export default function add(rules, which, rule) {
  ...
  if (regexp) {
    ...
    const re = rules[which].map(function (rule) {
