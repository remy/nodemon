...
bus.on('config:update', function () {
  ...
  if (config.system.useFind) {
    ...
    var watchFile = config.system.useWatch === false && (config.system.useWatchFile || config.options.forceLegacyWatch),
...
function filterAndRestart(files) {
  ...
  if (config.system.useFind || config.options.forceLegacyWatch) {
    if (config.run) {
...
var watch = module.exports = function () {
  ...
  if ((config.system.useFind || config.system.useWatch || config.system.useWatchFile) && !config.options.forceLegacyWatch) {
