...
function run(options) {
  ...
  if (runCmd) {
    ...
    // had another alternate approach, to stop process being forked/spawned in the below code
    // but found that this approach does early exit and makes code cleaner
