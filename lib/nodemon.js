...
function nodemon(settings) {
  // complete reset all the event listeners if we call nodemon
  // note that nodemon is a type of singleton, specifically: you can only have
  // one nodemon required at a time.
