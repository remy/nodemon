...
function createparams(filename, fallback) {
  ...
  const isQuotedString = textRegExp.test(name)
...
function format(obj) {
  ...
  const string = String(type).toLowerCase()
...
function decodefield(str) {
  const match = extValueRegExp.exec(str)
  ...
  // to binary string
  const binary = encoded.replace(hexEscapeReplaceRegExp, pdecode)
...
function parse(string) {
  ...
  const match = dispositionTypeRegExp.exec(string)
